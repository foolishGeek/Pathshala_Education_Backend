...
def send_mail_with_template(course_detail):
    ...
    context = {'username': course_detail['username'], 'course_name': course_detail['course_name'], 'batch_id': course_detail['batch_id'], 'course_activation_id': decrypt_val(course_detail['course_activation_id'])}
